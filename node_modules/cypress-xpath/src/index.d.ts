...
declare namespace Cypress {
  interface Chainable<Subject> {
    ...
    convertTextToHref(text: string): Chainable<string>;
    ...
    chooseHeader(headerName: string): Chainable<void>;
    ...
    verifyVisibilityOfElementUponMouseOver(elementName: string, classNameOfVisibleElement: string): Chainable<void>;
    /**
